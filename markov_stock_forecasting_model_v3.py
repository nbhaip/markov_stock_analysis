...
def get_data(security):
    ...
    :return: A Pandas DataFrame with columns: Date, Adj Close, and Percentage Change.
    """
...
def percent_change_as_time_plot(adjusted_df, security):
    ...
    plt.title("Percentage change in " + security.get_name() + " data", y=1.03)
...
def getLastClosingDate(adjusted_df):
    return adjusted_df['Adj Close'].iloc[-1]
